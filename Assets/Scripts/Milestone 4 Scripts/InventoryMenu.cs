...
public class InventoryMenu : MonoBehaviour
{
    ...
    {
        itemLabelText.text = inventoryObjectThatWasSelected.ObjectName.ToString();

        Debug.Log("Hello, This item is called" + inventoryObjectThatWasSelected);

        descriptionAreaText.text = inventoryObjectThatWasSelected.Description.ToString();
    }
    ...
    {
        if (Input.GetButtonDown("Show Inv"))
        {
            if (IsVisible)
            {
                HideMenu();
